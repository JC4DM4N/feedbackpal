    ...
    <div className="credits-page">
      <div className="credits-page-header">
        ...
        <p className="credits-page-sub">
          Credits are spent when you approve feedback on your apps, and earned when your reviews are approved.
        </p>
      </div>
      ...
      <div className="credits-explainer">
        ...
        <ul className="credits-explainer-list">
          <li>Each app you list has a credit value. When someone reviews your app and you approve it, that credit is transferred to the reviewer.</li>
          <li>While a review is in progress, the credit is held in escrow — you cannot spend it elsewhere until the review concludes.</li>
          <li>If a review is rejected or the reviewer abandons it, the credit returns to your available balance.</li>
          <li>Apps owned by users with no available credits are hidden from Explore until credits are topped up.</li>
        </ul>
      </div>
    </div>
  )
...
function StatCard({ label, value, hint, accent, positive }) {
  return (
    <div className={`credits-stat-card${accent ? ' credits-stat-card--accent' : ''}${positive ? ' credits-stat-card--positive' : ''}`}>
