...
INSERT INTO users (email, password, username) VALUES
    ...
    ('cadmcorp2@aol.com', '$2b$12$VUhFzGSdd2uzlAXt60B25Oc0kRadUdx3xE4Wl/V0f/DnYktm.BNLK', 'JamesC2')
...
INSERT INTO apps (owner_id, name, initials, color, url, category, stage, description, request, views, feedbacks, credits) VALUES
    ...
    (1, 'Pricewise',    'P', '#0ea5e9', 'pricewise.io',     'SaaS Tools',      'Pre-launch', 'Pricing page A/B testing for indie SaaS founders. No code required — just drop in a script tag and start testing in minutes.',                                        'Looking for feedback on the landing page clarity — does the value proposition make sense immediately? Does the setup flow feel simple enough for a non-technical founder?',                                              890,  8,   3),
